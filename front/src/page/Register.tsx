		...
		<>
			...
			<div className="flex  bg-zinc-50">
				...
				<div className="flex justify-center mt-24 w-full">
					<form action="" className="w-3/6 flex flex-col gap-4 mb-20">
						...
						<div className="max-h-fit max-w-fit">
							<label
								htmlFor="input-image"
								className="w-[400px] aspect-[16/9] flex items-center  rounded-sm   justify-center border-[2px] border-dashed border-violetPrimer"
							>
								<span className="">
									{previewImage ? (
										<img
										...
										<div className="flex items-center gap-2 text-violetPrimer">
